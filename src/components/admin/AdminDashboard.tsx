...
import type { Asset, AssetState, User, UserRole } from '../../types';
...
import {
  ...
  QrCode, Printer, PieChart, User as UserIcon, Calendar, Tag, Clock, Package,
        ...
        <div className="flex items-center justify-between gap-4 flex-wrap">
          ...
          <div className="flex gap-2">
            ...
            <Button
              ...
              disabled={page >= Math.ceil(total / USERS_PAGE_SIZE)}
            >
              Siguiente
            </Button>
          </div>
